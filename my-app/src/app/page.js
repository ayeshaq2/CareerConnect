...
export default function Home() {
  return (
    <div >
      <main className="main w-full min-h-screen">
        <h1 className="title">
      ...
      <style jsx global>{`
        ...
        .title {
          ...
          font-weight: 700;
          text-align: center;
          color: #2e7d32; /* Darker shade of green for text */
        }
        ...
        .card {
          ...
          border: 1px solid #a5d6a7; /* Softer green for border */
          border-radius: 50px;
          background-color: #81c784; / Soft forest green background for cards */
        ...
        .card:focus,
        .card:active {
          background-color: #66bb6a; /* Lighter shade of green on hover */
          border-color: #aed581; / Lighter shade for hover border */
        }
